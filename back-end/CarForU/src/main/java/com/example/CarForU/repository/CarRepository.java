...
public interface CarRepository extends JpaRepository<Car,Integer> {
    @Query("SELECT c FROM Car c WHERE c.carCondition ='มือหนึ่ง' order by c.carId DESC ")
    List<Car> findFirstHandCondition();
    @Query("SELECT c FROM Car c WHERE c.carCondition ='มือสอง' order by c.carId DESC")
    ...
    @Query("SELECT c FROM Car c WHERE (c.carHeader LIKE CONCAT('%', :keyword,'%') " +
            ...
            "and c.carSeats in :carSeats and c.carGearType LIKE CONCAT('%', :gear,'%') and c.carFuelType LIKE CONCAT('%', :fuelType,'%') and  c.carCondition='มือหนึ่ง' " +
    ...
    @Query("SELECT c FROM Car c WHERE (c.carHeader LIKE CONCAT('%', :keyword,'%') " +
            ...
            "and c.carSeats in :carSeats and c.carGearType LIKE CONCAT('%', :gear,'%') and c.carFuelType LIKE CONCAT('%', :fuelType,'%') and  c.carCondition='มือสอง' " +
            "ORDER BY c.carId DESC "
    )
